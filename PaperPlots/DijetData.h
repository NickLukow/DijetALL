	...
	double EWrun15x[7] = {18.87, 22.03, 26.88, 32.76, 39.76, 49.70, 68.49};
    ...
    double EWrun15sysx[7] = {0.61, 0.59, 0.69, 0.80, 0.92, 1.08, 1.30};
    double EWrun15sysy[7] = {7.10E-04, 6.97E-04, 9.20E-04, 1.11E-03, 1.45E-03, 1.86E-03, 3.04E-03};
    
	double EEWWrun15x[7] = {18.74, 21.96, 26.77, 32.68, 39.51, 49.34, 67.80};
	...
	double EEWWrun15sysx[7] = {0.52, 0.61, 0.67, 0.77, 0.89, 1.02, 1.32};
